...
const options = [
  {
    ...
    value: "Product 1",
    imgUrl:
      "https://cdn.shopify.com/s/files/1/0268/0124/2288/files/discount-offer-img.webp?v=1672908436",
    name: "Product 1",
    stars: "3",
    reviewCount: "2",
    price: "129",
...
const ProductUpsellSettings = (props) => {
      ...
      <div className="d-flex flex-column border-custom-rownd-border mx-3 mt-3">
        ...
        <div className="panel-body cust-min-height bg-white">
          ...
          <div className="form-group mx-3 my-3 bg-white text-start">
            ...
            <div className="color-picker  align-item-center gap-3 mb-3">
            {/* <label
              ...
              <input
      onChange={(e) => {
        handleChange(e.target.value, "offerDays");
      }}
      value={value?.["offerDays"]}
      type={"number"}
      min="0"
      max="365"
      className="form-control"
...
<label
              ...
              <input
      onChange={(e) => {
        handleChange(e.target.value, "offerHours");
      }}
      value={value?.["offerHours"]}
      type={"number"}
      min="0"
      max="24"
      className="form-control"
    ...
    />
            ...
            <label
              ...
              <input
      onChange={(e) => {
        handleChange(e.target.value, "offerMinutes");
      }}
      value={value?.["offerMinutes"]}
      type={"number"}
      min="0"
      max="60"
      className="form-control"
...
<label
              ...
              <input
      onChange={(e) => {
        handleChange(e.target.value, "offerSeconds");
      }}
      value={value?.["offerSeconds"]}
      type={"number"}
      min="0"
      max="60"
      className="form-control"
    ...
    />
            ...
            <div className="select-ia">
              ...
              <select className="form-select form-select-sm mb-3 "
               ...
               defaultValue={value?.discountType}
               onChange={(e) => {
                 handleChange(e.target.value, "discountType");
               }}
               >
            ...
            <div className="select-ia">
              ...
              <select className="form-select form-select-sm mb-3 "
               ...
               defaultValue={value?.productlabel }
               onChange={(e) => {
                const p = products.find(option => option.label === e.target.value)
                handleChange(p, "product");

               }}
               >
                {products?.map(option => (<option value={option.label} key={option.value}>{option.label}</option>))}
              </select>
            </div>
          </div>
        </div>
...
export default ProductUpsellSettings;

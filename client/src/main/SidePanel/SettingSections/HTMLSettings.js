...
const HTMLSettings = (props) => {
  ...
  const inputChanged = (value) => {
    updateConfig(type,{...dataset, html: value } )
  };
    ...
    <>
      ...
      />
        ...
        <div className="custom-me-new-find bg-white px-3 py-2">
          <a
            data-path="section-selector.php?method_name=deleted&amp;section=HTML Settings&amp;row_id=608302&amp;row_section_id=2463415&amp;shop=developement-store-test.myshopify.com"
          ...
          <a
            ...
            data-id="2463415"
            value="section-selector.php?shop=developement-store-test.myshopify.com&amp;method_name=enable_disable&amp;section=HTML Settings&amp;status=1&amp;row_section_id=2463415"
            title="Hide"
            onClick={()=> {
              if (value?.hide) {

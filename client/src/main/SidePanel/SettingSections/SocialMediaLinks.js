...
const SocialMediaLinks = (props) => {
  ...
  const inputChanged = (value) => {
    updateConfig(type,{...dataset, free_text: value } )
  };

  const iconStyleChanged = (value) => {
    updateConfig(type,{...dataset, iconStyle: value } )
  };

  const iconValueChanged = (value, key) => {
    updateConfig(type,{...dataset, [key]: value } )
  };

  const iconViewChanged = (value, key) => {
    updateConfig(type,{...dataset, [key]: value } )
  };
  ...
  return (
    ...
    <div>
      <div className="header-LeftSide d-flex col-12 align-items-center bg-white">
        ...
        <div className="template-title-text template-title">Social media links</div>
      </div>
    </div>
      ...
      <div className="panel-body cust-min-height bg-white">
        ...
        <div className="form-group mx-3 my-3 bg-white text-start">
          <div className="select-ft mb-3">
            ...
            <Editor
              ...
              onEditorStateChange={(e) => {
                setEditorState(e);
                inputChanged(draftToHtml(convertToRaw(editorState.getCurrentContent())));
              }}
            />
          </div>
          ...
          <div className="select-ia">
            ...
            <select className="form-select form-select-sm mb-4 " defaultValue={value?.iconStyle} onChange={(e) => {
iconStyleChanged(e.target.value)
            }}>
              ...
              <option value="round-edge">Round edge</option>
            </select>
          </div>

          <p class="first-h5 text-uppercase fw-semibold mb-1 pt-3 border-top" style={{ fontSize:"13px" }}>Social media links</p>

          <p class="" style={{ fontSize:"12px",color:"grey" }}>Add links to your social media profiles.</p>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewFacebook")
                }}
                value={value?.viewFacebook}
                defaultChecked={value?.viewFacebook}
            ...
            <input
              ...
              onChange={(e) => {iconValueChanged(e.target.value, "facebook")}}
            />
          </div>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewTwitter")
                }}
                value={value?.viewTwitter}
                defaultChecked={value?.viewTwitter}
                className="form-check-input"
                type="checkbox"
                style={{marginTop: "8px"}}
                id="viewTwitter"
            ...
            <input
              ...
              onChange={(e) => {iconValueChanged(e.target.value, "twitter")}}
            />
          </div>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewPinterest")
                }}
                value={value?.viewPinterest}
                defaultChecked={value?.viewPinterest}
                className="form-check-input"
                type="checkbox"
                style={{marginTop: "8px"}}
                id="viewPinterest"
            ...
            <input
              ...
              defaultValue={value?.pinterest}
              onChange={(e) => {iconValueChanged(e.target.value, "pinterest")}}
            />
          </div>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewInstagram")
                }}
                value={value?.viewInstagram}
                defaultChecked={value?.viewInstagram}
                className="form-check-input"
                type="checkbox"
                style={{marginTop: "8px"}}
                id="viewInstagram"
            ...
            <input
              ...
              onChange={(e) => {iconValueChanged(e.target.value, "instagram")}}
            />
          </div>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewLinkedIn")
                }}
                value={value?.viewLinkedIn}
                defaultChecked={value?.viewLinkedIn}
                className="form-check-input"
                type="checkbox"
                style={{marginTop: "8px"}}
                id="viewLinkedIn"
            ...
            <input
              ...
              onChange={(e) => {iconValueChanged(e.target.value, "linkedIn")}}
            />
          </div>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewTumblr")
                }}
                value={value?.viewTumblr}
                defaultChecked={value?.viewTumblr}
                className="form-check-input"
                type="checkbox"
                style={{marginTop: "8px"}}
                id="viewTumblr"
            ...
            <input
              ...
              aria-describedby="basic-addon3"
              value={value?.tumblr}
              defaultValue={value?.tumblr}
              onChange={(e) => {iconValueChanged(e.target.value, "tumblr")}}
            />
          </div>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewGoogle")
                }}
                value={value?.viewGoogle}
                defaultChecked={value?.viewGoogle}
                className="form-check-input"
                type="checkbox"
                style={{marginTop: "8px"}}
                id="viewGoogle"
            ...
            <input
              ...
              onChange={(e) => {iconValueChanged(e.target.value, "google")}}
            />
          </div>
          ...
          <input
                onChange={(e) => {
                  iconViewChanged(e?.target?.checked, "viewYouTube")
                }}
                value={value?.viewYouTube}
                defaultChecked={value?.viewYouTube}
                className="form-check-input"
                type="checkbox"
                style={{marginTop: "8px"}}
                id="viewYouTube"
            ...
            <input
              ...
              aria-describedby="basic-addon3"
              value={value?.youtube}
              defaultValue={value?.youtube}
              onChange={(e) => {iconValueChanged(e.target.value, "youtube")}}
            />
          </div>
          ...
          <div className="padding-bot-last-20px">
            {" "}
            <div
            ...
            >
              <div className="Polaris-Banner__ContentWrapper">
                <div
                  ...
                  id="PolarisBanner4Content"
                >
                  <p style={{ fontSize: "14px" }} className="m-0">
                    Auto play is not supported on some browsers including
                    Chrome.
                  </p>
                </div>
              </div>

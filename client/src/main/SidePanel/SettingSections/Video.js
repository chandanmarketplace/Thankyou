...
const Video = (props) => {
  ...
  const handleVideoTypeEvent = (value) => {
    updateConfig(type,{...dataset, video_type: value } )
  };

  const handleVideoIdEvent = (html) => {
    updateConfig(type,{...dataset, video_id: html } )
  };

  const handleVideoAutoPlayEvent = (html) => {
    updateConfig(type,{...dataset, ischecked: html } )
  };
    ...
    <>
      <div>
        <div className="header-LeftSide d-flex col-12 align-items-center bg-white">
          ...
          <div className="template-title-text template-title">Video</div>
        </div>
      </div>
        ...
        <div className="panel-body cust-min-height bg-white">
          ...
          <div className="form-group mx-3 my-3 bg-white text-start">
            ...
            <div className="select-ia">
              ...
              <select
              defaultValue={value?.video_type}
                onChange={(e) => {
                  handleVideoTypeEvent(e.target.value)
                }}
            ...
            <div className="input-group mb-3">
              <input
                onChange={(e) => {
                  handleVideoIdEvent(e?.target?.value)
                }}
            ...
            <div className="form-check">
              <input
                onChange={(e) => {
                  handleVideoAutoPlayEvent(e?.target?.checked)
                }}

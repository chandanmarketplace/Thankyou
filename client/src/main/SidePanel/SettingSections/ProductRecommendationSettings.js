...
const options = [
  {
    ...
    value: "Product 1",
    imgUrl:
      "https://cdn.shopify.com/s/files/1/0268/0124/2288/files/product-img1.webp?v=1672908436",
    name: "Denim Jacket",
    stars: "3",
    reviewCount: "2",
    price: "$129",
  },
  {
    ...
    value: "Product 2",
    imgUrl:
      "https://cdn.shopify.com/s/files/1/0268/0124/2288/files/product-img.webp?v=1672908435",
    name: "Leather jacket",
    stars: "3",
    reviewCount: "2",
    price: "$139",
  },
  {
    ...
    value: "Product 3",
    imgUrl:
      "https://cdn.shopify.com/s/files/1/0268/0124/2288/files/product-img2.webp?v=1672908435",
    name: "Black jacket",
    stars: "4",
    reviewCount: "4",
    price: "$99",
    ...
    <>
      ...
      <div className="d-flex flex-column border-custom-rownd-border mx-3 mt-3">
        ...
        <div className="panel-body cust-min-height bg-white">
          ...
          <div className="htmlForm-group mx-3 my-3 bg-white text-start">
